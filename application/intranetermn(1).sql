...
--
-- Host: localhost
-- Tempo de geração: 23/10/2017 às 19:38
...
(1, 'CB-RM2-TE SOUTO', 'ermn-021', 'computador apitando', '01-04-2017', '::1', 'SkyNet', 'aguardando', 'aguardando', 'aguardando', 'aguardando'),
(2, '1ÂºSG-CI Junior', 'ermn-024', 'sem acesso ao Score', '01-04-2017', '::1', 'SkyNet', 'aguardando', 'aguardando', 'aguardando', 'aguardando'),
(5, 'CB-RM2-TE SOUTO', 'ERMN-01', 'Teclado sem funcionar algumas teclas', '01-04-2017', '192.168.100.3', '192.168.100.3', 'concluÃ­do', 'substituiÃ§Ã£o de componente', 'sim', 'Teclado Multilaser ABNT-2'),
(6, 'CB-RM2-TE SOUTO', 'ermn-021', 'fonte do pc queimou', '01-04-2017', '192.168.100.10', 'SkyNet', 'concluido', 'substituiÃ§Ã£o de componente', 'sim', 'fonte 230w'),
(17, 'CB-RM2 TE Souto', 'ermn-1112', 'fdeoilrn', '17-07-2017', '172.23.40.207', 'localhost', 'aguardando', 'aguardando', 'aguardando', 'aguardando');
...
(3, '1508181111.jpg', 'Operador PadrÃ£o PR', 'ewewe', 'ewewewe');
